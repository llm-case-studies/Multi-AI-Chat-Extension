...
chrome.storage.sync.get('webhookUrl', (data) => {
  ...
  if (!chatContainer) {
    console.log('Chat container not found. Update .chat-container selector in gpt5_chat.js.');
    return;
  }
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  if (message.type === 'sendToAI' && (message.target === 'GPT-5' || message.target === 'All')) {
